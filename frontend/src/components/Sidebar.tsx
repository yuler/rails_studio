...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 border-r border-slate-200 dark:border-zinc-800 bg-slate-50/70 dark:bg-zinc-900/60 flex flex-col h-full min-h-0 select-none transition-colors">
      ...
      {/* Footer Info */}
      <div className="h-9 px-3 border-t border-slate-200 dark:border-zinc-800 bg-slate-100/50 dark:bg-zinc-950/40 text-[11px] text-slate-500 dark:text-zinc-500 flex items-center justify-between font-mono shrink-0">
