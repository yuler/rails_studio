                    ...
                    >
                      <div className="flex items-center space-x-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          <div className="font-medium truncate font-sans text-slate-900 dark:text-zinc-100">
                            {item.title}
                          </div>
                          {item.subtitle && (
                            <div className="text-[11px] text-slate-400 dark:text-zinc-500 truncate font-mono">
                              {item.subtitle}
                            </div>
                          )}
                        </div>
                      ...
                      <div className="flex items-center space-x-2 shrink-0 pl-2">
                        {item.shortcut && (
                          <kbd className="px-1.5 py-0.5 text-[10px] font-mono rounded border border-slate-200 dark:border-zinc-700 bg-white dark:bg-zinc-950 text-slate-500 dark:text-zinc-400">
                            {item.shortcut}
                          </kbd>
                        )}
                        {isActive && (
                          <CornerDownLeft size={13} className="text-slate-400 dark:text-zinc-500" />
                        )}
                      </div>
                    </div>
                  );
